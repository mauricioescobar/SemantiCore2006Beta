...
final public class FrameDomain extends JFrame implements ActionListener,
	Runnable {
    ...
    public FrameDomain(Environment env) {
	...
	this.setTitle("Domain - SemantiCore 2006");
	...
	while (this.isDisplayable()) {
	    try {
		Enumeration<DomainPart> parts = this.environment
		...
		while (parts.hasMoreElements()) {
		    DomainPart part = parts.nextElement();
		    defaultModel.addRow(new Object[] {
			    part.getDomainPartName(), part.getAddress(),
			    part.getPort() });
		}
